  ...
  return (
    ...
    style={{backgroundImage:
        ...
        <div className='overlay'>
            ...
            <div className='sub-size'><img src="https://cdn4.iconfinder.com/data/icons/essentials-72/24/029_-_Star-512.png" style={{width:17}}/> {(movie.vote_average).toFixed(1)} /10</div>
